...
with tab_current:
    ...
    # Render the complete process flow in one HTML block. This avoids Markdown
    # parsing individual indented fragments as literal code.
    st.markdown(process_flow_html(analysis_date, status_reference), unsafe_allow_html=True)
