...
PROCESS_STAGES = [
    ...
    },
    {
        ...
        "core": ["EOA_SS", "SRT_TSS_7d_Recalc_d", "Floc_Load_Excel", "EOA_SVI"],
        "details": [
...
PROCESS_DIAGRAM_NODES = [
    ...
    },
    {
        ...
        "core": ["EOA_SS", "SRT_TSS_7d_Recalc_d", "Floc_Load_Excel"],
        "hover": ["EOA_MLVSS", "EOA_SVI", "F_M_Total_Bio_7d", "Aeration_Inlet_Temperature"],
        "details": ["EOA_pH", "EOA_SS", "EOA_MLVSS", "MLVSS_MLSS_Ratio_Recalc", "Floc_Load_Excel", "F_M_Total_Bio_kgCOD_kgMLVSS_d", "F_M_Total_Bio_7d", "SRT_TSS_Daily_Recalc_d", "SRT_TSS_7d_Recalc_d", "SRT_TSS_14d_Recalc_d", "EOA_30min_Settling", "EOA_SVI", "SVI_Recalc_mL_g", "Aeration_Inlet_Temperature", "Online_MLSS_1", "Online_MLSS_2", "Aeration_II_HRT_h", "Aeration_II_Volumetric_COD_Load_kg_m3_d"],
    },
    {
...
with tab_current:
    ...
    key_snapshot = available([
        ...
        "SRT_TSS_7d_Recalc_d", "EOA_SVI", "EO_COD", "EO_TN"
    ])
    ...
    st.markdown("### Status overview — all key KPIs")
    st.markdown(
        compact_status_overview(CURRENT_KPIS, analysis_date, status_reference),
        unsafe_allow_html=True,
    )
